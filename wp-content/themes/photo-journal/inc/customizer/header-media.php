...
function photo_journal_header_media_options( $wp_customize ) {
	...
	photo_journal_register_option( $wp_customize, array(
			...
			'default'           => current_user_can( 'edit_theme_options' ) ? esc_html__( 'Header Media', 'photo-journal' ) : '',
    ...
    photo_journal_register_option( $wp_customize, array(
			...
			'default'           => current_user_can( 'edit_theme_options' ) ? esc_html__( 'Photography', 'photo-journal' ) : '',
			'sanitize_callback' => 'wp_kses_post',
