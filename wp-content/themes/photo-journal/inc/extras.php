...
function photo_journal_body_classes( $classes ) {
	...
	$header_media_title = get_theme_mod( 'photo_journal_header_media_title', esc_html__( 'Header Media', 'photo-journal' ) );
	$header_media_text  = get_theme_mod( 'photo_journal_header_media_text', esc_html__( 'Photography', 'photo-journal' ) );
